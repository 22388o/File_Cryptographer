...
class Widget(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        load_key_btn_key_frame = QtWidgets.QPushButton(key_frame)
        ...
        generate_key_btn_key_frame = QtWidgets.QPushButton(key_frame)
        ...
        self.selected_key_lbl_key_frame = QtWidgets.QLabel(key_frame)
